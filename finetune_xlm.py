import sys
sys.path.append('C:/Users/charl/Documents/GitHub/interpreting-complexity/src/')
            ...
            if not os.path.exists(results_path):
                with open(results_path, 'w', encoding='utf8') as outfile:
                    ...
                    for res in result[1:]:
                        ...
                        with open(f'out/preds_{args.run_name}.tsv', 'a', encoding='utf8') as preds_file:
...
def main():
    ...
    parser.add_argument(
        "--run_name", default='test-writing', type=str, required=True, help="The name of the experiment to be saved in MLflow"
    )
    parser.add_argument(
        "--data_dir",
        default='data/eyetracking/meco/files_per_language/English',
        type=str,
        required=True,
